scoreboard objectives remove jetpacks-iron 
scoreboard objectives remove jetpacks-fuel 
scoreboard objectives remove jetpacks-dead
scoreboard objectives remove jetpacks-tick
scoreboard objectives remove mineCooldown
scoreboard objectives remove tick-fuel
scoreboard objectives remove sound-tick
scoreboard objectives remove sound-enabled
scoreboard objectives remove grenadeReload
...
scoreboard objectives remove wrisDuration
