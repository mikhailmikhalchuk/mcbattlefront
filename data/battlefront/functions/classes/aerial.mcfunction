...
execute if entity @s[scores={defeated=2},team=FO] run item replace entity @s armor.chest with minecraft:iron_chestplate{display:{Name:'{"text":"NJP-900 Integrated Jetpack","color":"yellow","italic":false}'},Enchantments:[{id:"minecraft:binding_curse",lvl:1}],HideFlags:1,Tags:["hoverpack"]} 1
...
execute if entity @s[scores={defeated=2},team=RES] run item replace entity @s armor.feet with minecraft:leather_boots{display:{Name:'{"text":"Boots","color":"yellow","italic":false}'},Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:feather_falling",lvl:255}],Unbreakable:1,HideFlags:1} 1
...
execute if entity @s[scores={defeated=2},team=EMP] run item replace entity @s armor.feet with minecraft:leather_boots{display:{Name:'{"text":"Boots","color":"yellow","italic":false}',color:16383998},Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:feather_falling",lvl:255}],Unbreakable:1,HideFlags:1} 1
...
execute if entity @s[scores={defeated=2},team=REB] run item replace entity @s armor.feet with minecraft:leather_boots{display:{Name:'{"text":"Boots","color":"yellow","italic":false}'},Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:feather_falling",lvl:255}],Unbreakable:1,HideFlags:1} 1
...
execute if entity @s[scores={defeated=2},team=REP] run item replace entity @s armor.feet with minecraft:leather_boots{display:{Name:'{"text":"Armor","color":"yellow","italic":false}',color:16383998},Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:feather_falling",lvl:255}],Unbreakable:1,HideFlags:1} 1
...
execute if entity @s[scores={defeated=2},team=CIS] run item replace entity @s armor.feet with minecraft:leather_boots{display:{Name:'{"text":"Armor","color":"yellow","italic":false}',color:7567221},Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:feather_falling",lvl:255}],HideFlags:1} 1
