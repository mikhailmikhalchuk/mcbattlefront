...
execute as @a[scores={clickStick=1},nbt={SelectedItem:{tag:{Tags:["wristrocket"]}}}] run data modify entity @e[type=lightning_bolt,tag=sheevel,limit=1] Owner set from entity @s UUID
