...
execute at @a[scores={clickStick=1},nbt={SelectedItem:{tag:{Tags:["doubleeffort"]}}}] run effect give @a[distance=1..7,team=EMP] regeneration 5 3 true
execute at @a[scores={clickStick=1},nbt={SelectedItem:{tag:{Tags:["doubleeffort"]}}}] as @s if entity @p[distance=1..7,team=EMP] run effect give @s regeneration 5 3 true
