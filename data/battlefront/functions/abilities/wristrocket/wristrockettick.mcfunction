...
execute as @a[scores={clickStick=1,retrDuration=1..},nbt={SelectedItem:{tag:{Tags:["wristrocket"]}}}] run tellraw @s {"text":"Cannot use item! Abilities are restricted.","color":"red"}
execute as @a[scores={clickStick=1,retrDuration=1..},nbt={SelectedItem:{tag:{Tags:["wristrocket"]}}}] run scoreboard players set @s clickStick 0
...
execute as @a[scores={clickStick=1},nbt={SelectedItem:{tag:{Tags:["wristrocket"]}}}] at @s positioned ~ ~1 ~ run summon fireball ~ ~ ~ {ExplosionPower:3,Tags:["wrprojectile"]}
...
execute as @a[scores={wrisCooldown=1000..}] run scoreboard players set @s wrisCooldown 0
