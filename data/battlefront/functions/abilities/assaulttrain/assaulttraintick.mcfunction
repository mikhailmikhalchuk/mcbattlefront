...
execute as @a[scores={tranCooldown=1..,show-actionbar-cooldown=1},nbt={SelectedItem:{tag:{Tags:["assaulttrain"]}}}] run title @s actionbar ["",{"score":{"name":"*","objective":"tranCooldown"},"color":"red"},{"text":"/800","color":"red"}]
execute as @a[scores={tranCooldown=0,show-actionbar-cooldown=1},nbt={SelectedItem:{tag:{Tags:["assaulttrain"]}}}] run title @s actionbar {"text":"Ready!","color":"green"}