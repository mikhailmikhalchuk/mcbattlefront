...
execute as @a[scores={clickStick=1,abilitiesBlocked=1..},nbt={SelectedItem:{tag:{Tags:["seektactic"]}}}] run tellraw @s {"text":"Cannot use item! Abilities are restricted.","color":"red"}
execute as @a[scores={clickStick=1,abilitiesBlocked=1..},nbt={SelectedItem:{tag:{Tags:["seektactic"]}}}] run scoreboard players set @s clickStick 0
...
execute as @a[scores={seekCooldown=1500..}] run scoreboard players set @s seekCooldown 0