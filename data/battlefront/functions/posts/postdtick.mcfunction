...
execute at @e[type=armor_stand,team=CIS,tag=D] as @e[type=armor_stand,team=CIS,tag=D] if score @s postD matches 200 run setblock ~ ~-1 ~ minecraft:blue_stained_glass replace
