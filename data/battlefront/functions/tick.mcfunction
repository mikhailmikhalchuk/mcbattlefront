...
execute as @e[type=armor_stand,tag=TimerHolder,scores={timer=1..}] store result bossbar minecraft:timer value run scoreboard players get @s timer
execute as @e[type=armor_stand,tag=TimerHolder,scores={timer=1..}] run scoreboard players remove @s timer 1
