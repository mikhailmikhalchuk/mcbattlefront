...
execute as @a[scores={pbatCooldown=100..,defeated=0}] run give @s minecraft:iron_sword{CustomModelData:50,display:{Name:'{"text":"Phasma\'s baton","color":"red","italic":false}'},HideFlags:1,Unbreakable:1} 1
