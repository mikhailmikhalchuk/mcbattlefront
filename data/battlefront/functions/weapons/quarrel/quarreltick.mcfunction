...
execute as @a[scores={clickStick=1},nbt={SelectedItem:{tag:{Tags:["quarrel"]}}}] run data modify entity @e[type=fireball,tag=quarprojectile,limit=1] Owner set from entity @s UUID
