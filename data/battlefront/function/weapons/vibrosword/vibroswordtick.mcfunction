...
execute as @a[scores={vibroCooldown=80..,defeated=0}] run give @s minecraft:stone_sword[item_name={"color":"red","italic":false,"text":"Vibrosword"},tooltip_display={hidden_components:["enchantments","unbreakable","attribute_modifiers"]},lore=[{"italic":false,"text":"Gains bonus damage on third strike"}],unbreakable={},custom_data={vibrosword:true}]
