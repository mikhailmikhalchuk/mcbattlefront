...
execute as @a[scores={pbatCooldown=100..,defeated=0}] run give @s minecraft:iron_sword[item_name={"color":"red","italic":false,"text":"Phasma's baton"},tooltip_display={hidden_components:["unbreakable","attribute_modifiers"]},unbreakable={}] 1
