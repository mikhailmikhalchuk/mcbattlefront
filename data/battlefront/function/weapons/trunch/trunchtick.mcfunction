...
execute as @a[scores={trunCooldown=80..,defeated=0}] run give @s minecraft:stone_sword[item_name={"color":"red","italic":false,"text":"Truncheon"},unbreakable={},custom_data={trunch:true}]
