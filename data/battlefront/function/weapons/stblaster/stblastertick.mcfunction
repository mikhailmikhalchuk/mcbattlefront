execute as @a[scores={clickStick=1,stCooldown=0}] if items entity @s weapon *[custom_data~{sithgun:true}] at @s anchored eyes positioned ~ ~1.5 ~ run summon arrow ~ ~ ~ {Tags:["stprojectile","removegravity"]}
execute as @a[scores={clickStick=1,stCooldown=0}] if items entity @s weapon *[custom_data~{sithgun:true}] at @s rotated as @s positioned 0.0 0 0.0 positioned ^ ^ ^5 summon area_effect_cloud run data modify entity @e[tag=stprojectile,limit=1] Motion set from entity @s Pos
execute as @a[scores={clickStick=1,stCooldown=0}] if items entity @s weapon *[custom_data~{sithgun:true}] run data modify entity @e[type=arrow,tag=stprojectile,limit=1] Owner set from entity @s UUID
execute as @a[scores={clickStick=1,stCooldown=0}] if items entity @s weapon *[custom_data~{sithgun:true}] at @s run playsound minecraft:stblast block @a ~ ~ ~ 0.3
execute as @a[scores={clickStick=1,stCooldown=0}] if items entity @s weapon *[custom_data~{sithgun:true}] run scoreboard players set @s stCooldown 1
execute as @a[scores={clickStick=1,stCooldown=1}] if items entity @s weapon *[custom_data~{sithgun:true}] run scoreboard players set @s clickStick 0
