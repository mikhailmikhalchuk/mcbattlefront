...
execute at @e[type=armor_stand,team=CIS,tag=B] as @e[type=armor_stand,team=CIS,tag=B] if score @s postB matches 200 run setblock ~ ~-1 ~ minecraft:blue_stained_glass replace
