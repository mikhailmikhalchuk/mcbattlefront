...
execute as @e[type=armor_stand,team=RES,tag=A] if score @s postA matches 1 run waypoint modify @s color red
...
execute as @e[type=armor_stand,team=FO,tag=A] if score @s postA matches 1 run waypoint modify @s color blue
...
execute as @e[type=armor_stand,team=REB,tag=A] if score @s postA matches 1 run waypoint modify @s color red
...
execute as @e[type=armor_stand,team=CIS,tag=A] if score @s postA matches 1 run waypoint modify @s color blue
