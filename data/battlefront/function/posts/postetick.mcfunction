...
execute at @e[type=armor_stand,team=CIS,tag=E] as @e[type=armor_stand,team=CIS,tag=E] if score @s postE matches 200 run setblock ~ ~-1 ~ minecraft:red_stained_glass replace
