...
execute as @a[scores={jumpCooldown=140..}] run scoreboard players set @s jumpCooldown 0
...
execute as @a[scores={jumpCooldown=1..}] if items entity @s weapon *[custom_data~{jumppack:true}] run title @s actionbar ["",{"score":{"name":"*","objective":"secondsHelper"},"color":"red"},{"text":"/7 seconds","color":"red"}]
