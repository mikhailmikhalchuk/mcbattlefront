...
execute if entity @s[scores={defeated=2},team=RES] run give @s minecraft:crossbow[item_name={"italic":false,"text":"EL-16HFE blaster"},unbreakable={},enchantments={"minecraft:quick_charge":3}] 1
...
execute if entity @s[scores={defeated=2},team=EMP] run give @s minecraft:crossbow[item_name={"italic":false,"text":"E-11 blaster"},unbreakable={},enchantments={"minecraft:quick_charge":3}] 1
...
execute if entity @s[scores={defeated=2},team=REB] run give @s minecraft:crossbow[item_name={"italic":false,"text":"A280C blaster"},unbreakable={},enchantments={"minecraft:quick_charge":3}] 1
...
#clone jump trooper
execute if entity @s[scores={defeated=2},team=REP] run give @s minecraft:crossbow[item_name={"italic":false,"text":"DC-17"},unbreakable={},enchantments={"minecraft:quick_charge":3}] 1
