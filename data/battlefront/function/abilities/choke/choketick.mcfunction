...
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{choke:true}] at @s anchored eyes facing entity @p[team=REB,distance=..6] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.6] rotated ~ 0 run attribute @p[team=REB,distance=..10] minecraft:entity_interaction_range base set 0
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{choke:true}] at @s anchored eyes facing entity @p[team=REB,distance=..6] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.6] rotated ~ 0 run attribute @p[team=REB,distance=..10] minecraft:attack_speed base set 0
...
execute as @a[scores={chokeDuration=1..}] at @s rotated ~ 0 if block ^ ^1 ^3 air if block ^ ^1 ^4 air run tp @a[tag=choked] ^ ^1 ^3 facing ^ ^1 ^
execute as @a[scores={chokeDuration=1..}] at @s rotated ~ 0 unless block ^ ^1 ^3 air run tp @a[tag=choked] ^ ^1 ^2 facing ^ ^1 ^
execute as @a[scores={chokeDuration=1..}] at @s rotated ~ 0 unless block ^ ^1 ^2 air run tp @a[tag=choked] ^ ^1 ^1 facing ^ ^1 ^
execute as @a[scores={chokeDuration=1..}] at @s rotated ~ 0 unless block ^ ^1 ^1 air run tp @a[tag=choked] ^ ^1 ^ facing ^ ^1 ^
...
execute as @a[scores={chokeDuration=60..}] run attribute @a[tag=choked,limit=1] minecraft:entity_interaction_range base reset
execute as @a[scores={chokeDuration=60..}] run attribute @a[tag=choked,limit=1] minecraft:attack_speed base reset
execute as @a[scores={chokeDuration=60..}] run tag @a remove choked
