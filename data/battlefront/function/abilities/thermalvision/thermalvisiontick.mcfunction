execute as @a[scores={clickStick=1,thermCooldown=1..}] if items entity @s weapon *[custom_data~{thermvision:true}] run tellraw @s ["",{"text":"Cannot use item!\n","color":"red"},{"score":{"name":"*","objective":"thermCooldown"},"color":"red"},{"text":" of 750 ticks (1/20ths of a second) remaining.","color":"red"}]
...
execute as @a[scores={thermCooldown=1..,show-actionbar-cooldown=1}] if items entity @s weapon *[custom_data~{thermvision:true}] run title @s actionbar ["",{"score":{"name":"*","objective":"thermCooldown"},"color":"red"},{"text":"/750","color":"red"}]
execute as @a[scores={thermCooldown=0,show-actionbar-cooldown=1}] if items entity @s weapon *[custom_data~{thermvision:true}] run title @s actionbar {"text":"Ready!","color":"green"}