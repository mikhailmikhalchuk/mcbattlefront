...
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{restrict:true}] if predicate {condition:entity_properties,entity:this,predicate:{flags:{is_on_ground:true}}} at @s if entity @p[team=CIS,distance=..6] run scoreboard players set @p[team=CIS,distance=..6] abilitiesBlocked 100
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{restrict:true}] if predicate {condition:entity_properties,entity:this,predicate:{flags:{is_on_ground:true}}} at @s if entity @p[team=CIS,distance=..6] run tellraw @p[team=CIS,distance=..6] {"text":"Hit by Obi-Wan Kenobi's restrictive mind trick!","color":"red"}
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{restrict:true}] if predicate {condition:entity_properties,entity:this,predicate:{flags:{is_on_ground:true}}} at @s if entity @p[team=CIS,distance=..6] run tellraw @s ["",{"text":"Restricted the abilities of ","color":"green"},{"selector":"@a[distance=..6,team=CIS]"},{"text":".","color":"green"}]
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{restrict:true}] if predicate {condition:entity_properties,entity:this,predicate:{flags:{is_on_ground:true}}} at @s if entity @p[team=CIS,distance=..6] run scoreboard players set @s restrCooldown 1
