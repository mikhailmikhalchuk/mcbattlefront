...
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] at @s unless block ~ ~-1 ~ air run effect give @p[team=REP,distance=..6] weakness 10 0 true
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] at @s unless block ~ ~-1 ~ air run effect clear @p[team=REP,distance=..6] absorption
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] at @s unless block ~ ~-1 ~ air run tellraw @p[team=REP,distance=..6] {"text":"Hit by Count Dooku's expose weakness!","color":"red"}
...
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] at @s unless block ~ ~-1 ~ air as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] if entity @p[team=REP,distance=..6] run scoreboard players set @s weakCooldown 1
execute as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] at @s as @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{expose:true}] unless block ~ ~-1 ~ air run scoreboard players set @s clickStick 0
