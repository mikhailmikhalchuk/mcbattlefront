...
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{seektactic:true}] run effect give @a[team=RES,limit=4,sort=nearest] glowing 10 0 true
