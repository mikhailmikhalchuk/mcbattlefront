...
execute as @a[scores={pullCooldown=1..}] if items entity @s weapon *[custom_data~{pull:true}] run title @s actionbar ["",{"score":{"name":"*","objective":"secondsHelper"},"color":"red"},{"text":"/30 seconds","color":"red"}]
