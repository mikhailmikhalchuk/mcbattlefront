...
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run effect give @a[distance=..5,team=FO] slowness 5 3 true
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run effect give @a[distance=..5,team=FO] nausea 5 0 true
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run effect give @a[distance=..5,team=FO] blindness 5 50 true
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run tellraw @a[distance=..5,team=FO] {"text":"Hit by Rey's mind trick!","color":"red"}
...
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run title @a[distance=..5,team=FO] title {"text":"iAMthesenatenotyet","obfuscated":true}
execute at @a[scores={clickStick=1}] if items entity @s weapon *[custom_data~{mindtrick:true}] unless block ~ ~-1 ~ air if entity @p[distance=..5,team=FO] run title @a[distance=..5,team=FO] subtitle {"text":"butyoubelongtoreachyourbodyyourarmor","obfuscated":true}
